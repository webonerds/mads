...
if($.fn.wl_Editor) $.fn.wl_Editor.defaults = {
	css: 'template/css/fansunite/editor.css',
	buttons: 'bold|italic|underline|strikeThrough|justifyLeft|justifyCenter|justifyRight|justifyFull|highlight|colorpicker|indent|outdent|subscript|superscript|undo|redo|insertOrderedList|insertUnorderedList|insertHorizontalRule|createLink|h1|h2|h3|h4|h5|h6|paragraph|rtl|ltr|cut|copy|paste|increaseFontSize|decreaseFontSize|html|removeFormat|insertTable|insertYouTube',
	initialContent: '',
	rmUnwantedBr: true,
